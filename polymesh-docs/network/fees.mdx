...
- registering a new ticker: this has a 25 POLYX fee. Note this fee is also charged if directly creating an asset without first registering a ticker in a separate transaction.
