...
To provide these services with stable reference points, the CA pallet uses [checkpoints](../assets/fungible_assets/#checkpoints) to determine an investor's balance and the total supply.
