...
Polymesh uses public-key cryptography based on the [Ed25519 curve](https://docs.substrate.io/learn/cryptography/#elliptic-curve), and allows keys that use either the Ed25519 or SR25519 constructions.
