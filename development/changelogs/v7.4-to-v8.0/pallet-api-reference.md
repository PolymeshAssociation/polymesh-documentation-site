...
> Mechanically generated, pallet-by-pallet reference of every added, removed, and modified call, event, error, storage item, and constant between Polymesh chain v7.4 and v8.0, derived from on-chain runtime metadata.
