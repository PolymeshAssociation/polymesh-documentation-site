...
> Run a complete Polymesh stack locally with Docker Compose, including the node, indexer, REST APIs, Vault, and optional Ethereum JSON-RPC and Blockscout explorer
