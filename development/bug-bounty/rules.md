...
Please read these terms and conditions (these “**Terms**”), which form a legally binding contract between Polymesh Labs Limited (“**Polymesh**” or “**us**” or “**our**” in context) and qualifying individuals (“**Participant**” or “**you**” and “**your**” in context) who wish to participate in this bug bounty program (the “**Program**”) and identify vulnerabilities in our in-scope products (“**Vulnerabilities**”). Participants that submit acceptable Vulnerability Reports shall be eligible to earn a payout (a “**Bounty Payout**”), as determined solely at Polymesh's discretion, in accordance with these Terms.
