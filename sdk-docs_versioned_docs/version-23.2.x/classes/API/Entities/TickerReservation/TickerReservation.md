...
[api/entities/TickerReservation/index.ts:54](https://github.com/PolymeshAssociation/polymesh-sdk/blob/daafaa68f/src/api/entities/TickerReservation/index.ts#L54)
...
▸ **createAsset**(`args`, `opts?`): `Promise`\<[`GenericPolymeshTransaction`](../../../../modules/Types/Types.md#genericpolymeshtransaction)\<[`FungibleAsset`](../Asset/Fungible/FungibleAsset.md), [`FungibleAsset`](../Asset/Fungible/FungibleAsset.md)\>\>
...
`Promise`\<[`GenericPolymeshTransaction`](../../../../modules/Types/Types.md#genericpolymeshtransaction)\<[`FungibleAsset`](../Asset/Fungible/FungibleAsset.md), [`FungibleAsset`](../Asset/Fungible/FungibleAsset.md)\>\>
...
[api/entities/TickerReservation/index.ts:189](https://github.com/PolymeshAssociation/polymesh-sdk/blob/daafaa68f/src/api/entities/TickerReservation/index.ts#L189)
...
[api/entities/TickerReservation/index.ts:94](https://github.com/PolymeshAssociation/polymesh-sdk/blob/daafaa68f/src/api/entities/TickerReservation/index.ts#L94)
...
[api/entities/TickerReservation/index.ts:95](https://github.com/PolymeshAssociation/polymesh-sdk/blob/daafaa68f/src/api/entities/TickerReservation/index.ts#L95)
...
[api/entities/TickerReservation/index.ts:214](https://github.com/PolymeshAssociation/polymesh-sdk/blob/daafaa68f/src/api/entities/TickerReservation/index.ts#L214)
...
[api/entities/TickerReservation/index.ts:176](https://github.com/PolymeshAssociation/polymesh-sdk/blob/daafaa68f/src/api/entities/TickerReservation/index.ts#L176)
...
[api/entities/TickerReservation/index.ts:227](https://github.com/PolymeshAssociation/polymesh-sdk/blob/daafaa68f/src/api/entities/TickerReservation/index.ts#L227)
...
[api/entities/TickerReservation/index.ts:207](https://github.com/PolymeshAssociation/polymesh-sdk/blob/daafaa68f/src/api/entities/TickerReservation/index.ts#L207)
