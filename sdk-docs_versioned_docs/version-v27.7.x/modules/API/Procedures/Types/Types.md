...
- [CreateBallotParams](../../../../interfaces/API/Procedures/Types/CreateBallotParams/CreateBallotParams.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `votes` | [`BallotVote`](../../Entities/CorporateBallot/Types/Types.md#ballotvote)[][] | The votes to be cast. **`Note`** Votes for all motion choices must be provided. |
...
Ƭ **CorporateBallotParams**: `Omit`\<[`CreateBallotParams`](../../../../interfaces/API/Procedures/Types/CreateBallotParams/CreateBallotParams.md), ``"declarationDate"`` \| ``"rcv"``\> & \{ `declarationDate`: `Date` ; `rcv`: `boolean`  }
...
[api/procedures/types.ts:427](https://github.com/PolymeshAssociation/polymesh-sdk/blob/8a9e72221/src/api/procedures/types.ts#L427)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `checkpoint` | [`InputCaCheckpoint`](../../Entities/Asset/Fungible/Checkpoints/Types/Types.md#inputcacheckpoint) \| ``null`` | The checkpoint of the Corporate Action (the record date on which the Corporate Action is applied) |
...
| `kind` | [`CorporateActionKind`](../../../../enums/API/Entities/CorporateActionBase/Types/CorporateActionKind/CorporateActionKind.md) | The kind of Corporate Action to initiate |
| `targets` | [`InputCorporateActionTargets`](Types.md#inputcorporateactiontargets) \| ``null`` | The targets of the Corporate Action |
| `taxWithholdings` | [`InputTaxWithholding`](../../Entities/CorporateActionBase/Types/Types.md#inputtaxwithholding)[] | The tax withholdings to be applied to the Corporate Action |
...
Ƭ **ModifyCorporateBallotParams**: `Partial`\<`Pick`\<[`CreateBallotParams`](../../../../interfaces/API/Procedures/Types/CreateBallotParams/CreateBallotParams.md), ``"meta"`` \| ``"endDate"`` \| ``"rcv"``\>\> & \{ `ballot`: [`CorporateBallot`](../../../../classes/API/Entities/CorporateBallot/CorporateBallot.md) \| `BigNumber`  }
