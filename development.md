...
- **[Smart Contracts](/development/smart-contracts):** Learn about deploying and interacting with smart contracts on Polymesh using `pallet-revive` (a dual-VM engine supporting native PolkaVM and full EVM/Solidity compatibility) and native modules.
...
- **[Chain Changelogs](/development/changelogs):** Runtime-level breaking changes, new features, and migration guidance for each Polymesh chain release — for exchanges, node operators, and anyone integrating with the chain API directly.
