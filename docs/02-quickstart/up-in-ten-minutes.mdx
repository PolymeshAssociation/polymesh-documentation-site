...
<OverviewBox title="Get the Wallet" linkHref="/docs/quickstart/wallet" linkText="Get the Wallet" imgSrc="/img/tmpAssets/07_get_wallet_v2-01.svg" floating="true">
...
<OverviewBox title="Get Verified" linkHref="/docs/quickstart/verification-with-cdd" linkText="Get Verified" imgSrc="/img/tmpAssets/08_get_verified_v3-01.svg" floating="true">
...
<OverviewBox title="Get POLYX" linkHref="/docs/quickstart/quickstart-polyx" linkText="Get POLYX" imgSrc="/img/tmpAssets/09_get_polyx_v2-01.svg" floating="true">
