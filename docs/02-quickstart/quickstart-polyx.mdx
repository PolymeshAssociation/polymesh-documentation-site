...
Getting testnet POLYX couldn't be simpler. If you have already

<a href="./wallet/">set up your wallet</a> and completed the testnet <a href="./verification-with-cdd/">
  mock certified due diligence process
</a>
, you will automatically have been credited with Testnet POLYX.
