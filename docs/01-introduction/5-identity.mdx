...
Intuitively, you know that someone wrote the words, possibly a team of people. But you also know that this publication comes from The Polymesh Association, and The Polymesh Association, is responsible for what is written here.
...
A **Polymesh ID** can be an individual or an organisation.

This brings us to the first important pillar that will support our understanding of Polymesh Identities:

> An **ID** represents an individual or an organisation. A ID may control more than one account but no individual or organization should have more than one real world ID.
...
<a href="/polymesh-docs/network/ledger/">Ledger signing hardware</a> can be used
to safeguard signing keys.
...
Portfolios relate strongly to custody on Polymesh. For a more detailed account, take a look at the [Portfolios and Custody](/polymesh-docs/primitives/portfolios-custody/) page.
...
For more information on this topic, prospective KYC service providers should review the admission process described [here](/docs/kyc/know-your-customer/).
...
For a more in-depth look at CDD on Polymesh, dive right into [Polymesh's CDD](/docs/kyc/know-your-customer/).
