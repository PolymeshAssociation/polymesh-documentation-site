...
<OverviewBox title="The technical stack" linkHref="/docs/introduction/tech-stack" linkText="Technical Stack" imgSrc={useBaseUrl("/img/tmpAssets/02_technical_stack-01.svg")} floating="true">
...
<OverviewBox title="Identity" linkHref="/docs/introduction/identity" linkText="Identity" imgSrc={useBaseUrl("/img/tmpAssets/04_identity-01.svg")} floating="true">
...
<OverviewBox title="Governance" linkHref="/docs/introduction/governance" linkText="Governance" imgSrc={useBaseUrl("/img/tmpAssets/05_governance-01.svg")} floating="true">
