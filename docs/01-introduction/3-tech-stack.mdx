...
[https://dashboard.polymath.network/](https://dashboard.polymath.network/up-in-ten-minutes).

For a step-by-step on how to setup everything, so that you can start playing around with the Dashboard, take a look at [Quick Start](/docs/quickstart/up-in-ten-minutes).
...
You want to have a look at the Polymesh SDK, check out this [documentation](https://github.com/PolymeshAssociation/polymesh-sdk/wiki).
...
- [Polymesh SDK](https://github.com/PolymeshAssociation/polymesh-sdk/wiki)
