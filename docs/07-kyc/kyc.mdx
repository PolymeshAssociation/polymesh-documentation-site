...
<OverviewBox title="Overview: KYC" linkHref="/docs/kyc/know-your-customer" linkText="Overview" imgSrc="/img/tmpAssets/illu-p-screen.svg">
...
<ActionCardWrapper>
  <ActionCard
    href="/kyc/kyc-dashboard"
    text="KYC compliance with the Dashboard"
    desc="Let's discover how KYC compliance can be managed through your browser and the Polymesh Dashboard."
  ></ActionCard>
  <ActionCard
    href="/kyc/kyc-sdk"
    showDevSign="true"
    text="Providing KYC using the SDK"
    desc="How the SDK can help to ensure and provide KYC on-chain. Let's explore an example scenario."
  ></ActionCard>
</ActionCardWrapper>

<OverviewBox title="Dive into further resources" linkHref="https://github.com/PolymeshAssociation/polymesh-sdk/wiki" linkText="Explore" imgSrc="/img/tmpAssets/illu-p-code.svg" external="true">
