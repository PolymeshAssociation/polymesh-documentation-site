...
<OverviewBox title="Overview: KYC" linkHref="../know-your-customer/" linkText="Overview" imgSrc={useBaseUrl("/img/tmpAssets/illu-p-screen.svg")}>
...
<OverviewBox title="Dive into further resources" linkHref="/sdk-docs/" linkText="Explore" imgSrc={useBaseUrl("/img/tmpAssets/illu-p-code.svg")} external={false}>
