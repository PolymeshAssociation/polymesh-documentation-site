...
<OverviewBox title="Overview: Distributing assets with Polymesh" linkHref="/distribute/distribution-process" linkText="Overview" imgSrc="/img/tmpAssets/illu-p-screen.svg">
