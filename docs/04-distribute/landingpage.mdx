...
<OverviewBox title="Overview: Distributing assets with Polymesh" linkHref="/distribute/distribution-process" linkText="Overview" imgSrc={useBaseUrl("/img/tmpAssets/illu-p-screen.svg")}>
