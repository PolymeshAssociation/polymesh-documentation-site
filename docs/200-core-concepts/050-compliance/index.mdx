...
- `CustomerDueDiligence`: This claim can only be issued by trusted [CDD](/identity/verification) service providers, granting general access to the Polymesh network.
