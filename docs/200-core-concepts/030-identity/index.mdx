...
This diagram demonstrates how an identity can have multiple [portfolios](/portfolios) (default, user, custodial) to organize and manage [assets](/assets), including both fungible and non-fungible tokens.
