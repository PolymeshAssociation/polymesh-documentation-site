...
Native [assets](/assets) (excluding [POLYX](/polyx)) held by users are associated with their identities and can be organized into [portfolios](/portfolios/custody/). Each identity can hold multiple assets and manage them through different portfolios. Identities can also be granted [agent permissions](/external-agents) to perform specific operations on behalf of asset issuers.
