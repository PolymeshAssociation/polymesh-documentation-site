...
<OverviewBox title="Overview: Corporate action on Polymesh" linkHref="/actions/executing-actions" linkText="Overview" imgSrc="/img/tmpAssets/illu-p-screen.svg">
