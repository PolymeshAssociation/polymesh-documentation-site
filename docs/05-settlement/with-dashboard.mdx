...
Change to Bob's Polymesh DID in the portal and navigate to the `Transfers` tab in the Polymesh Portal: https://portal.polymesh.network/portfolio.

Bob has one incoming transfer. It is 1,000 ACME shares.

![incoming](images/08-incoming-bob2.png)

Accept the transfer and receive the shares.

Once received, Bob may wish to move some or all of his shares to another portfolio.
