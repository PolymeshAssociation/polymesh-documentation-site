...
- **[EVM & Smart Contracts](/development/smart-contracts):** Learn about deploying and interacting with smart contracts on Polymesh using `pallet-revive` (a dual-VM engine supporting native PolkaVM and full EVM/Solidity compatibility) and native modules.
- **[Precompiles](/development/smart-contracts/precompiles):** Call native Polymesh functionality from contracts — including using any fungible asset as a standard [ERC-20 token](/development/smart-contracts/precompiles/fungible-asset), with compliance and settlement still enforced.
