---
title: Native Asset Holdings Changelog - v7.4 to v8.0
description: Breaking changes to the Asset, NFT, and Portfolio pallets in Polymesh chain v8 - the AssetHolder model that lets accounts hold assets directly, not just portfolios.
id: v7.4-to-v8.0-native-asset-holdings
slug: /development/changelogs/v7.4-to-v8.0/native-asset-holdings
sidebar_label: Native Asset Holdings
tags:
  - migration
  - changelog
  - runtime
