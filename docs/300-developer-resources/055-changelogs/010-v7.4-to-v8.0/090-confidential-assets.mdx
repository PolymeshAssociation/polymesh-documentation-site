---
title: Confidential Assets Changelog - v7.4 to v8.0
description: Polymesh chain v8 adds the new Confidential Assets (PCA) pallet - available on Testnet and Develop, not yet on Mainnet.
id: v7.4-to-v8.0-confidential-assets
slug: /development/changelogs/v7.4-to-v8.0/confidential-assets
