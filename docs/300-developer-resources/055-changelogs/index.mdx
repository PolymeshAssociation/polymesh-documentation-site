...
- **[v8.0 → v8.1.1](./v8.0-to-v8.1.1/)** — minor release: native assets exposed to EVM code through precompiles — ERC-20 for fungible assets (with partial ERC-3643 and ERC-7943 coverage), ERC-721 for NFT collections, and a general-purpose runtime precompile — plus holder-level asset freezing, NFT approvals, ETH wallets as subsidy beneficiaries and MultiSig signers, and a Grandpa warp-sync fix.
