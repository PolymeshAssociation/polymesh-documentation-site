...
### 9.4 Pre-deployed Multicall3 and CREATE2 proxy

From chain v8.1, development chain specs also carry [Multicall3](https://github.com/mds1/multicall3) (`0xcA11bde05977b3631167028862bE2a173976CA11`) and the [deterministic-deployment CREATE2 proxy](https://github.com/Arachnid/deterministic-deployment-proxy) (`0x4e59b44847b379578588920ca78fbf26c0b4956c`) in genesis, at the same canonical addresses they occupy on other EVM chains. Tooling that assumes they exist — viem and wagmi batch their reads through Multicall3, and Foundry uses the CREATE2 proxy for deterministic deploys — works against a fresh local chain with no setup.

These are also present on Polymesh's live networks, deployed there manually. See [Pre-deployed standard contracts](/development/smart-contracts#pre-deployed-standard-contracts).

### 9.5 Deploying a contract
...
### 9.6 Using the Blockscout explorer
