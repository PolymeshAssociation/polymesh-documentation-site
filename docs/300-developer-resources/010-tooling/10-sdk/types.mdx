...
While the main [Polymesh SDK](./) abstracts away most direct blockchain interactions, `polymesh-types` serves developers who need to work at a lower level, typically using libraries like [`@polkadot/api`](https://polkadot.js.org/docs/api/).
...
*   **Polymesh SDK Documentation:** [`/development/tooling/sdk`](/development/tooling/sdk)
