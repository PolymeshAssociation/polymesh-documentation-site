...
<OverviewBox title="Overview: The Polymesh solution to asset origination" linkHref="/originate/origination-process" linkText="Overview" imgSrc={useBaseUrl("/img/tmpAssets/illu-p-screen.svg")}>
