...
Since this action is materially significant, Alice will have to first complete [customer due diligence](/docs/quickstart/verification-with-cdd). You will also need POLYX to pay network transaction fees. If you don't have any, or don't have enough, [get some free Testnet POLYX](/docs/quickstart/quickstart-polyx).
...
For now, let's just reserve the symbol. Click on 'Go to ticker reservation'.
