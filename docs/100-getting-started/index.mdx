...
2. [**Identity Verification**](/getting-started/onboarding) - Polymesh requires A valid CDD for identity and asset related transactions. This verification assigns you an on-chain [Identity](/identity) and is essential for maintaining regulatory compliance. Once verified, you'll receive a Customer Due Diligence (CDD) claim that enables you to:

   - Perform identity and asset related transactions
