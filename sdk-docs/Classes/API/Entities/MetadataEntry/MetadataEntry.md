[api/entities/MetadataEntry](../../../../Modules/API/Entities/MetadataEntry.md).MetadataEntry

Represents an Asset MetadataEntry in the Polymesh blockchain

## Hierarchy

- [`Entity`](../Entity/Entity.md)<[`UniqueIdentifiers`](../../../../Interfaces/API/Entities/MetadataEntry/UniqueIdentifiers.md), [`HumanReadable`](../../../../Interfaces/API/Entities/MetadataEntry/HumanReadable.md)\>
...
[api/entities/MetadataEntry/index.ts:37](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/MetadataEntry/index.ts#L37)
...
[api/entities/MetadataEntry/index.ts:47](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/MetadataEntry/index.ts#L47)
...
[api/entities/MetadataEntry/index.ts:42](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/MetadataEntry/index.ts#L42)
...
▸ **details**(): `Promise`<[`MetadataDetails`](../../../../Interfaces/API/Entities/MetadataEntry/Types/MetadataDetails.md)\>

Retrieve name and specs for this MetadataEntry

#### Returns

`Promise`<[`MetadataDetails`](../../../../Interfaces/API/Entities/MetadataEntry/Types/MetadataDetails.md)\>
...
| Name | Type |
| :------ | :------ |
| `args` | [`SetMetadataParams`](../../../../Modules/API/Procedures/Types.md#setmetadataparams) |
...
▸ **toHuman**(): [`HumanReadable`](../../../../Interfaces/API/Entities/MetadataEntry/HumanReadable.md)
...
▸ **value**(): `Promise`<``null`` \| [`MetadataValue`](../../../../Modules/API/Entities/MetadataEntry/Types.md#metadatavalue)\>
...
`Promise`<``null`` \| [`MetadataValue`](../../../../Modules/API/Entities/MetadataEntry/Types.md#metadatavalue)\>
