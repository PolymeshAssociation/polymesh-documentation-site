[api/entities/DividendDistribution](../../../../Modules/API/Entities/DividendDistribution.md).DividendDistribution
...
[api/entities/CorporateActionBase/index.ts:80](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/CorporateActionBase/index.ts#L80)
...
[api/entities/DividendDistribution/index.ts:102](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/DividendDistribution/index.ts#L102)
...
[api/entities/CorporateActionBase/index.ts:85](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/CorporateActionBase/index.ts#L85)
...
[api/entities/CorporateActionBase/index.ts:101](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/CorporateActionBase/index.ts#L101)
...
[api/entities/CorporateActionBase/index.ts:90](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/CorporateActionBase/index.ts#L90)
...
[api/entities/DividendDistribution/index.ts:118](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/DividendDistribution/index.ts#L118)
...
[api/entities/CorporateActionBase/index.ts:75](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/CorporateActionBase/index.ts#L75)
...
[api/entities/DividendDistribution/index.ts:113](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/DividendDistribution/index.ts#L113)
...
[api/entities/DividendDistribution/index.ts:97](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/DividendDistribution/index.ts#L97)
...
[api/entities/DividendDistribution/index.ts:123](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/DividendDistribution/index.ts#L123)
...
[api/entities/DividendDistribution/index.ts:107](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/DividendDistribution/index.ts#L107)

___

### targets

• **targets**: [`CorporateActionTargets`](../../../../Interfaces/API/Entities/CorporateActionBase/Types/CorporateActionTargets.md)
...
[api/entities/CorporateActionBase/index.ts:96](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/CorporateActionBase/index.ts#L96)

___

### taxWithholdings

• **taxWithholdings**: [`TaxWithholding`](../../../../Interfaces/API/Entities/CorporateActionBase/Types/TaxWithholding.md)[]
...
[api/entities/CorporateActionBase/index.ts:107](https://github.com/PolymeshAssociation/polymesh-sdk/blob/15be87e8/src/api/entities/CorporateActionBase/index.ts#L107)
...
this method is of type [NoArgsProcedureMethod](../../../../Interfaces/Types/NoArgsProcedureMethod.md), which means you can call [claim.checkAuthorization](../../../../Interfaces/Types/NoArgsProcedureMethod.md#checkauthorization)
...
▸ **details**(): `Promise`<[`DividendDistributionDetails`](../../../../Interfaces/API/Entities/DividendDistribution/Types/DividendDistributionDetails.md)\>

Retrieve details associated with this Dividend Distribution

#### Returns

`Promise`<[`DividendDistributionDetails`](../../../../Interfaces/API/Entities/DividendDistribution/Types/DividendDistributionDetails.md)\>
...
▸ **getParticipant**(`args?`): `Promise`<``null`` \| [`DistributionParticipant`](../../../../Interfaces/API/Entities/DividendDistribution/Types/DistributionParticipant.md)\>
...
`Promise`<``null`` \| [`DistributionParticipant`](../../../../Interfaces/API/Entities/DividendDistribution/Types/DistributionParticipant.md)\>

___

### getParticipants

▸ **getParticipants**(): `Promise`<[`DistributionParticipant`](../../../../Interfaces/API/Entities/DividendDistribution/Types/DistributionParticipant.md)[]\>
...
`Promise`<[`DistributionParticipant`](../../../../Interfaces/API/Entities/DividendDistribution/Types/DistributionParticipant.md)[]\>
...
▸ **getPaymentHistoryV2**(`opts?`): `Promise`<[`ResultSet`](../../../../Interfaces/Types/ResultSet.md)<[`DistributionPayment`](../../../../Interfaces/Types/DistributionPayment.md)\>\>
...
this method is of type [ProcedureMethod](../../../../Interfaces/Types/ProcedureMethod.md), which means you can call [linkDocuments.checkAuthorization](../../../../Interfaces/Types/ProcedureMethod.md#checkauthorization)
  on it to see whether the signing Account and Identity have the required roles and permissions to run it
...
| Name | Type |
| :------ | :------ |
| `args` | [`LinkCaDocsParams`](../../../../Interfaces/API/Procedures/Types/LinkCaDocsParams.md) |
| `opts?` | [`ProcedureOpts`](../../../../Interfaces/Types/ProcedureOpts.md) |
...
this method is of type [ProcedureMethod](../../../../Interfaces/Types/ProcedureMethod.md), which means you can call [modifyCheckpoint.checkAuthorization](../../../../Interfaces/Types/ProcedureMethod.md#checkauthorization)
  on it to see whether the signing Account and Identity have the required roles and permissions to run it
...
| Name | Type |
| :------ | :------ |
| `args` | [`Modify`](../../../../Modules/Types/Utils.md#modify)<[`ModifyCaCheckpointParams`](../../../../Interfaces/API/Procedures/Types/ModifyCaCheckpointParams.md), { `checkpoint`: [`InputCaCheckpoint`](../../../../Modules/API/Entities/Asset/Checkpoints/Types.md#inputcacheckpoint)  }\> |
| `opts?` | [`ProcedureOpts`](../../../../Interfaces/Types/ProcedureOpts.md) |
...
this method is of type [ProcedureMethod](../../../../Interfaces/Types/ProcedureMethod.md), which means you can call [pay.checkAuthorization](../../../../Interfaces/Types/ProcedureMethod.md#checkauthorization)
  on it to see whether the signing Account and Identity have the required roles and permissions to run it
...
| Name | Type |
| :------ | :------ |
| `args` | [`PayDividendsParams`](../../../../Interfaces/API/Procedures/Types/PayDividendsParams.md) |
| `opts?` | [`ProcedureOpts`](../../../../Interfaces/Types/ProcedureOpts.md) |
...
this method is of type [NoArgsProcedureMethod](../../../../Interfaces/Types/NoArgsProcedureMethod.md), which means you can call [reclaimFunds.checkAuthorization](../../../../Interfaces/Types/NoArgsProcedureMethod.md#checkauthorization)
  on it to see whether the signing Account and Identity have the required roles and permissions to run it
...
▸ **toHuman**(): [`HumanReadable`](../../../../Interfaces/API/Entities/DividendDistribution/HumanReadable.md)
