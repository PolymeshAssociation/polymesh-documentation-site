...
> Changes between Polymesh SDK v30.1.0 and v30.2.0. Includes registrar-gated DID registration, portfolio-level asset pre-approval, new settlement/asset getters, Ledger signing fixes, and corrected POLYX balance/off-chain receipt handling for chain v8.
