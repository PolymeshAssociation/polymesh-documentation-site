...
> Changes between Polymesh SDK v30.2.0 and v31.0.0. Drops all chain v7 support — the SDK now targets chain v8 only. Includes breaking changes, deprecations, new features, bug fixes, and migration steps.
