...
> Defined in: [src/api/entities/Identity/ChildIdentity.ts:13](https://github.com/PolymeshAssociation/polymesh-sdk/blob/a7c926afa47310145607dc47eeba1d09b58421b6/src/api/entities/Identity/ChildIdentity.ts#L13)
...
[`Identity`](../../classes/Identity.mdx).[`assetPermissions`](../../classes/Identity.mdx#assetpermissions)
...
[`Identity`](../../classes/Identity.mdx).[`authorizations`](../../classes/Identity.mdx#authorizations)
...
[`Identity`](../../classes/Identity.mdx).[`did`](../../classes/Identity.mdx#did)
...
[`Identity`](../../classes/Identity.mdx).[`portfolios`](../../classes/Identity.mdx#portfolios)
...
[`Identity`](../../classes/Identity.mdx).[`uuid`](../../classes/Identity.mdx#uuid)
...
[`Identity`](../../classes/Identity.mdx).[`areSecondaryAccountsFrozen`](../../classes/Identity.mdx#aresecondaryaccountsfrozen)
...
[`Identity`](../../classes/Identity.mdx).[`checkRoles`](../../classes/Identity.mdx#checkroles)
...
Defined in: [src/api/entities/Identity/ChildIdentity.ts:80](https://github.com/PolymeshAssociation/polymesh-sdk/blob/a7c926afa47310145607dc47eeba1d09b58421b6/src/api/entities/Identity/ChildIdentity.ts#L80)
...
[`Identity`](../../classes/Identity.mdx).[`exists`](../../classes/Identity.mdx#exists)
...
[`Identity`](../../classes/Identity.mdx).[`getAssetBalance`](../../classes/Identity.mdx#getassetbalance)
...
[`Identity`](../../classes/Identity.mdx).[`getHeldAssets`](../../classes/Identity.mdx#getheldassets)
...
[`Identity`](../../classes/Identity.mdx).[`getHeldNfts`](../../classes/Identity.mdx#getheldnfts)
...
[`Identity`](../../classes/Identity.mdx).[`getHistoricalInstructions`](../../classes/Identity.mdx#gethistoricalinstructions)
...
[`Identity`](../../classes/Identity.mdx).[`getInstructions`](../../classes/Identity.mdx#getinstructions)
...
[`Identity`](../../classes/Identity.mdx).[`getInvolvedInstructions`](../../classes/Identity.mdx#getinvolvedinstructions)
...
[`Identity`](../../classes/Identity.mdx).[`getMultiSigSigners`](../../classes/Identity.mdx#getmultisigsigners)
...
[`Identity`](../../classes/Identity.mdx).[`getOffChainAuthorizationNonce`](../../classes/Identity.mdx#getoffchainauthorizationnonce)

***

### ~~getParentDid()~~

> **getParentDid**(): `Promise`\<[`Identity`](../../classes/Identity.mdx) \| `null`\>

Defined in: [src/api/entities/Identity/ChildIdentity.ts:34](https://github.com/PolymeshAssociation/polymesh-sdk/blob/a7c926afa47310145607dc47eeba1d09b58421b6/src/api/entities/Identity/ChildIdentity.ts#L34)

Returns the parent of this Identity (if any)

#### Returns

`Promise`\<[`Identity`](../../classes/Identity.mdx) \| `null`\>
...
[`Identity`](../../classes/Identity.mdx).[`getPendingDistributions`](../../classes/Identity.mdx#getpendingdistributions)
...
[`Identity`](../../classes/Identity.mdx).[`getPrimaryAccount`](../../classes/Identity.mdx#getprimaryaccount)
...
[`Identity`](../../classes/Identity.mdx).[`getSecondaryAccounts`](../../classes/Identity.mdx#getsecondaryaccounts)
...
[`Identity`](../../classes/Identity.mdx).[`getTrustingAssets`](../../classes/Identity.mdx#gettrustingassets)
...
[`Identity`](../../classes/Identity.mdx).[`getVenues`](../../classes/Identity.mdx#getvenues)
...
[`Identity`](../../classes/Identity.mdx).[`hasRole`](../../classes/Identity.mdx#hasrole)
...
[`Identity`](../../classes/Identity.mdx).[`hasValidCdd`](../../classes/Identity.mdx#hasvalidcdd)
...
[`Identity`](../../classes/Identity.mdx).[`isAssetPreApproved`](../../classes/Identity.mdx#isassetpreapproved)
...
[`Identity`](../../classes/Identity.mdx).[`isCddProvider`](../../classes/Identity.mdx#iscddprovider)
...
[`Identity`](../../classes/Identity.mdx).[`isChild`](../../classes/Identity.mdx#ischild)
...
[`Identity`](../../classes/Identity.mdx).[`isEqual`](../../classes/Identity.mdx#isequal)
...
[`Identity`](../../classes/Identity.mdx).[`isGcMember`](../../classes/Identity.mdx#isgcmember)
...
[`Identity`](../../classes/Identity.mdx).[`isMandatoryReceiverAffirmationEnabled`](../../classes/Identity.mdx#ismandatoryreceiveraffirmationenabled)
...
[`Identity`](../../classes/Identity.mdx).[`preApprovedAssets`](../../classes/Identity.mdx#preapprovedassets)
...
[`Identity`](../../classes/Identity.mdx).[`setMandatoryReceiverAffirmation`](../../classes/Identity.mdx#setmandatoryreceiveraffirmation)
...
[`Identity`](../../classes/Identity.mdx).[`toHuman`](../../classes/Identity.mdx#tohuman)
...
[`Identity`](../../classes/Identity.mdx).[`unlinkChild`](../../classes/Identity.mdx#unlinkchild)

***

### ~~unlinkFromParent()~~

> **unlinkFromParent**(`opts?`: [`ProcedureOpts`](../../../../procedures/types/interfaces/ProcedureOpts.mdx)): `Promise`\<[`GenericPolymeshTransaction`](../../../../procedures/types/type-aliases/GenericPolymeshTransaction.mdx)\<`void`, `void`\>\>

Defined in: [src/api/entities/Identity/ChildIdentity.ts:95](https://github.com/PolymeshAssociation/polymesh-sdk/blob/a7c926afa47310145607dc47eeba1d09b58421b6/src/api/entities/Identity/ChildIdentity.ts#L95)
...
this method is of type [NoArgsProcedureMethod](../../../../procedures/types/interfaces/NoArgsProcedureMethod.mdx), which means you can call [unlinkFromParent.checkAuthorization](../../../../procedures/types/interfaces/NoArgsProcedureMethod.mdx#checkauthorization) on it to see whether the signing Account and Identity have the required roles and permissions to run it
...
[`Identity`](../../classes/Identity.mdx).[`generateUuid`](../../classes/Identity.mdx#generateuuid)
...
[`Identity`](../../classes/Identity.mdx).[`unserialize`](../../classes/Identity.mdx#unserialize)
